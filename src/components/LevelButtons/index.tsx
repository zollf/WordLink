...
import { useStore, useAnimate } from 'app/src/hooks';
import Button from '../Button';

import { ElasticSlideIn, FadeSlideIn } from 'app/src/animations';
...
const LevelButtons = () => {
  ...
  useEffect(() => {
    Animated.parallel([
      Animated.stagger(50, [ElasticSlideIn(easy), ElasticSlideIn(medium), ElasticSlideIn(hard)]),
      Animated.stagger(50, [FadeSlideIn(easy_opacity), FadeSlideIn(medium_opacity), FadeSlideIn(hard_opacity)]),
    ]).start();
  });
